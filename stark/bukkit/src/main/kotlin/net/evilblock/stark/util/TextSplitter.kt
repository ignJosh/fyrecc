...
object TextSplitter {
    ...
    @JvmStatic fun split(length: Int, lines: List<String>, linePrefix: String, wordSuffix: String): List<String> {
    ...
    @JvmStatic fun split(length: Int, text: String, linePrefix: String, wordSuffix: String): List<String> {
