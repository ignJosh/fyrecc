package net.evilblock.stark.util.cuboid;
...
public class Cuboid implements Iterable<Block>, Cloneable, ConfigurationSerializable {
    ...
    /**
     * Construct a Cuboid using a dyeMap with the following keys: worldName, x1, x2, y1, y2, z1, z2
     *
     * @param map - The dyeMap of keys.
     */
